...
//    public Servo wrist = null;
    ...
    final double LAUNCHER_TARGET_RPM_ClOSE = 165;   // 目标转速
    final double LAUNCHER_MIN_RPM_ClOSE = 160;    // 判定可发射阈值
    ...
    private AutoRight.LaunchState launchState;
...
//        }
        ...
        encoderDrive(DRIVE_SPEED, 30, 30, 20);
//        try {
//            Thread.sleep(500);
//        } catch (InterruptedException e) {
//            e.printStackTrace();
//        }
        encoderDrive(TURN_SPEED, 41, -42, 20);
